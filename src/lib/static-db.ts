...
export const SEED_MENUS: Menu[] = [
  ...
  // ── COCKTAIL (17종) ──────────────────────────────────────────
  m(nextId(), "cat-200", "Godfather",             "갓파더",            16000, null, { origin: "Cocktail", abv: 33,  imageUrl: "/menu/godfather.jpg",  description: "Bourbon · Disaronno 등. 33% — 묵직한 단맛과 아몬드의 깊이.", isRecommended: true }),
  m(nextId(), "cat-200", "Cherry Old Fashioned",  "체리 올드패션드",   16000, null, { origin: "Cocktail", abv: 26,  imageUrl: "/menu/cherry-old-fashioned.jpg",  description: "Bourbon · Angostura 등. 26% — 체리 향이 더해진 고전적 한 잔.", isRecommended: true }),
  m(nextId(), "cat-200", "Wild Flower Julep",     "와일드 플라워 쥴렙",16000, null, { origin: "Cocktail",           imageUrl: "/menu/wild-flower-julep.jpg",  description: "민트와 야생화의 풍미가 어우러진 봄 같은 쥴렙.", isRecommended: true }),
  m(nextId(), "cat-200", "Virgin Berry Mojito",   "버진 베리 모히또",  12000, null, { origin: "Cocktail · Non-Alc", abv: 0, imageUrl: "/menu/virgin-berry-mojito.jpg",  description: "논알콜. 베리와 라임의 상큼한 모히또. (알콜 추가 +3,000원)" }),
  m(nextId(), "cat-200", "Virgin Lime Mojito",    "버진 라임 모히또",  12000, null, { origin: "Cocktail · Non-Alc", abv: 0, imageUrl: "/menu/virgin-lime-mojito.jpg",  description: "논알콜. 라임과 민트의 클래식한 모히또. (알콜 추가 +3,000원)" }),
  m(nextId(), "cat-200", "Faust",                 "파우스트",          16000, null, { origin: "Cocktail",           imageUrl: "/menu/faust.jpg",  description: "바텐더의 시그니처 한 잔." }),
  m(nextId(), "cat-200", "Gin & Tonic",           "진토닉",            13000, null, { origin: "Cocktail · Gin",     imageUrl: "/menu/gin-tonic.jpg",  description: "잘 짜여진 클래식 진토닉. 라임 한 조각." }),
  m(nextId(), "cat-200", "Gin Fizz",              "진피즈",            16000, null, { origin: "Cocktail · Gin",     imageUrl: "/menu/gin-fizz.jpg",  description: "레몬·설탕·소다의 부드러운 거품, 그리고 진의 향." }),
  m(nextId(), "cat-200", "Gin Rickey",            "진리키",            16000, null, { origin: "Cocktail · Gin",     imageUrl: "/menu/gin-rickey.jpg",  description: "라임과 진의 가장 깔끔한 만남." }),
  m(nextId(), "cat-200", "Daiquiri",              "다이키리",          16000, null, { origin: "Cocktail · Rum",     imageUrl: "/menu/daiquiri.jpg",  description: "럼·라임·설탕의 정직한 삼각형." }),
  m(nextId(), "cat-200", "Cold Brew Martini",     "콜드브루 마티니",   16000, null, { origin: "Cocktail · Coffee",  imageUrl: "/menu/cold-brew-martini.jpg",  description: "콜드브루의 깊이와 보드카의 차가움이 어우러진 한 잔.", isRecommended: true }),
  ...
  m(nextId(), "cat-200", "두유하이",              "두유하이",          16000, null, { origin: "Cocktail", abv: 10,  imageUrl: "/menu/soy-milk-high.jpg", description: "Bourbon, butterscotch etc." }),
  m(nextId(), "cat-200", "라프로익 패션드",       "라프로익 패션드",   17000, null, { origin: "Cocktail",           imageUrl: "/menu/laphroaig-fashioned.jpg" }),
  m(nextId(), "cat-200", "라프로익 페니실린",     "라프로익 페니실린", 17000, null, { origin: "Cocktail",           imageUrl: "/menu/laphroaig-penicillin.jpg" }),
  m(nextId(), "cat-200", "비터진",                "비터진",            13000, null, { origin: "Cocktail · Gin",     imageUrl: "/menu/bitter-gin.jpg" }),
  m(nextId(), "cat-200", "커피앤시가렛",          "커피앤시가렛",      16000, null, { origin: "Cocktail",           imageUrl: "/menu/coffee-and-cigarettes.jpg", description: "라프로익베이스의 피트 칵테일, 탐의 피트를 재해석한 시그니처 칵테일", isRecommended: true }),
